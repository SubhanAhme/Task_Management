              ...
              Stack(
               ...
               Row(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Image.asset("assets/images/Ellipse709.png",color: const Color(0xFFB1D199)),
                    const SizedBox(width: 10,),
                     Text("To do",style: GoogleFonts.poppins(
                            textStyle: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w400,
                              color: Color(0xFF002055),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Image.asset("assets/images/Ellipse709.png",color: const Color(0xFFFFB35A),),
                    const SizedBox(width: 10,),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Image.asset("assets/images/Ellipse709.png",color: const Color(0xFF756EF3),),
                    const SizedBox(width: 10,),
                    Text("Complete",style: GoogleFonts.poppins(
                                textStyle: const TextStyle(
                                  fontSize: 14,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                textStyle: const TextStyle(
                                 ...
                                 Text("18 tasks now",style: GoogleFonts.poppins(
                                textStyle: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xFF848A94),
