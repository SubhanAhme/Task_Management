...
class _MembersListState extends State<MembersList> {
  ...
  Widget build(BuildContext context) {
    List<Members> Member = Members.memberList
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Row(
            ...
            children: [
              Text(selectedMember.length.toString() + ' selected',
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Member[index].isSelected == true
                    ? Border.all(
                ...
                Text(
                  ...
                  style: GoogleFonts.poppins(
                    textStyle: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.w600,
                      color: Member[index].isSelected == true
